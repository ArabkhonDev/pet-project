        ...
        <div className="container">
          ...
          <div className="bimm-about_contents">
            <h4>
              ...
              tashkil etish Bosh ilmiy-metodik markazi O‘zbekiston Respublikasi
              Vazirlar Mahkamasining 2012 yil 26 sentyabrdagi “Oliy ta’lim m
              uassasalari pedagog kadrlarini qayta tayyorlash va ularning
              malakasini oshirish tizimini yanada takomillashtirish
              chora-tadbirlari to‘g‘risida”gi 278-son qarori bilan tashkil
              etilgan.
            </h4>
            <p>
              <b>Bosh ilmiy-metodik markazning maqsadi</b> – oliy ta’lim tizimi
              pedagog va rahbar kadrlarini qayta tayyorlash va malakasini
              oshirish jarayonlari sifatini takomillashtirish va monitoringini
              olib borish, ularni me’yoriy va metodik ta’minotini amalga
              oshirish, qayta tayyorlash va malaka oshirish jarayonlariga
              zamonaviy pedagogik va axborot-kommunikatsiya texnologiyalarini
              keng joriy etilishini tashkillashtirishdan iborat.{" "}
            </p>
            <li>
              <p>
                <b>
                  Bosh ilmiy-metodik markazning asosiy vazifalari quyidagilardan
                  iborat:{" "}
                </b>
              </p>
            </li>
            <li>
              ...
              metodikalardan foydalangan holda oliy ta’lim muassasalari pedagog
              kadrlarini qayta tayyorlash va ularning malakasini oshirish
              bo‘yicha o‘quv reja va dasturlari, o‘quv-metodik va me’yoriy
            ...
            <li>
              ...
              tarmoqlari bo‘yicha mamlakatimizning ilg‘or zamonaviy uskunalar va
              texnologiyalar bilan jihozlangan korxonalar bilan hamkorlik qilish
              hamda ulardan pedagoglarni qayta tayyorlash va ularning malakasini
              oshirish uchun bazaviy ob’yektlar sifatida foydalanish bo‘yicha
            ...
            <li>
              ...
              zamonaviy talablarga muvofiq oliy ta’lim sifatini ta’minlash uchun
              zarur bo‘lgan kasbiy ko‘nikmalari va layoqatlari rivojlanishining
              o‘zgarishini baholab borish;
            </li>
            <li>
              - bazaviy oliy ta’lim muassasalari bilan birgalikda ilg‘or xorijiy
              tajribani hisobga olgan holda chet tillari va zamonaviy
            ...
            <li>
              ...
              laboratoriyalari va shu kabilar) bilan hamkorlik qilish, tegishli
              ta’lim fanlari bo‘yicha o‘quv dasturlari mazmunini
              ...
              malakasini oshirish uchun bazaviy ob’yektlar sifatida foydalanish
              dasturlarini ishlab chiqish;
            </li>
            <li>
              - mintaqaviy va tarmoq markazlari faoliyatini muvofiqlashtirish,
              oliy ta’lim muassasalarining rahbar xodimlari (rektor, prorektor,
              dekan va bo‘lim boshliqlari) malakasini oshirish kurslarini
